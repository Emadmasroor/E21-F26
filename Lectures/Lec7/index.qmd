...
[The first bit is reserved for the sign. `1` $\implies$ negative.]{.fragment}
...
1. What is the largest (+) number that can be shown using A and B ?
2. What is the smallest difference between two numbers that can be represented using A and B ?
...
1. What each of the 8 digits are. 
...
[So the number is $-1.066406250 \times 2^{4} = \fbox{4.265625}$]{.fragment}
